...
function Onboard() {
  ...
  if (step === 1) {
    return (
      <Box maxWidth={350} mx="auto" my={5} p={3} borderRadius={2} boxShadow={2} bgcolor="#fff">
        <Typography variant="h5" mb={2}>Welcome!</Typography>
        <Typography mb={2}>Your account is created. Please log in to continue.</Typography>
        <Button variant="contained" color="primary" onClick={handleFinish}>Go to Login</Button>
      </Box>
    );
  }
  ...
  return (
    <Box maxWidth={350} mx="auto" my={5} p={3} borderRadius={2} boxShadow={2} bgcolor="#fff">
      <Typography variant="h5" mb={2}>Onboard</Typography>
